...
SWIGINTERN PyObject *_wrap_TFmdm_set_cosm(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "TFmdm_set_cosm", 7, 7, swig_obj)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "TFmdm_set_cosm", _wrap_TFmdm_set_cosm, METH_VARARGS, NULL},
	 { "TFmdm_onek_mpc", _wrap_TFmdm_onek_mpc, METH_O, NULL},
	 { "TFmdm_onek_hmpc", _wrap_TFmdm_onek_hmpc, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "tf_cbnu", Swig_var_tf_cbnu_get, Swig_var_tf_cbnu_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
